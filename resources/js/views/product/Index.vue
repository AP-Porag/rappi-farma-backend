                            ...
                            <v-menu transition="slide-x-transition">
                                ...
                                <v-list>
                                    <v-list-item-group class="datatable-action-item">
                                        ...
                                        <v-list-item @click="$router.push({ name: 'edit-product',params:{id:item.id} })" class="datatable-dropdown-item">
                                            <v-list-item-icon>
                                        ...
                                        <v-list-item @click="$router.push({ name: 'show-product',params:{id:item.id} })">
                                            <v-list-item-icon>
